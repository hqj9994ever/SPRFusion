...
from model.model_static import ModelPlain as M
...
def main(config):
    ...
    current_epoch = max(init_epoch_A, init_epoch_D, init_epoch_G)

    model_plain = M(config)
    model_plain.init_train(init_paths=[init_path_A, init_path_D, init_path_G])
